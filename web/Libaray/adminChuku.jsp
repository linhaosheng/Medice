...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">出库管理</strong> </div>
        </div>
        <br>
        <br>

        <form class="am-form am-form-horizontal am-u-sm-12 am-u-md-10 am-u-lg-7" id="admin-frm" method="post"
              action="../outStorage.action">
            ...
            <div class="am-form-group">
                <label class="am-u-sm-4 am-u-md-4 am-u-lg-3 am-form-label"style="text-align: left"> 仓库 </label>
                <div class="am-u-sm-8 am-u-md-8 am-u-lg-9 ">
  ...
  <s:if test="#session.status==110">
      <script type="text/javascript">
          alert("成功");
      </script>
  </s:if>
   <s:elseif test="#session.status==-2100">
       <script type="text/javascript">
           alert("库存不足");
       </script>
   </s:elseif>
 <s:elseif test="#session.status==-110">
     <script type="text/javascript">
         alert("成功");
     </script>
 </s:elseif>
