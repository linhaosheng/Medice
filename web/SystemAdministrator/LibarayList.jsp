...
<div class="am-cf admin-main">
            ...
            <ul class="am-list admin-sidebar-list">
                ...
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                        <li><a href="../getLibaray.action" class="am-cf"><span class="am-icon-file"></span>仓库管理员</a></li>
                        <li><a href="../getDrugAdministrator.action"><span class="am-icon-file"></span>药品管理员</a></li>
                    </ul>
                </li>
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">仓库管理员列表</strong>
            </div>
        </div>
        <br><br>
        ...
        <br class="am-g">
            ...
            <form >
                <tr>
                    <td>
                        <s:iterator value="#session.listLib" var="item">
